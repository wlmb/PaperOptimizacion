...
\newcommand{\notaV}[1]{{\bf \em \color{orange}VCG: #1}}
...
method \notaL{reference} \cite{Pochi2005, Ariza2011} \notaV{Agregue dos referencias}. 
Assuming the system is 1D, with variations
...
where $M_{ij}$ \notaL{Quité las tildes, pues hubiera sido necesario
  explicarlas, y no creo que sean importantes para el lector} \notaV{Tiene raz\'{o}, esto se debe diferenciar en la informacion suplementaria} are the elements
...
TM polarization.\notaL{En el cálculo, ¿tomaste las partes reales? No
  estaban en la fórmula} \notaV{Realmente inclu\'{i} la transmitancia solo por completez (no inclu\'{i} c\'{a}lculo alguno)} The complex refractive index of the porous
