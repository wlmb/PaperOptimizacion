...
structure.
As in $\mathcal R_2$ the absorption of porous silicon is negligible,
the periods are distributed quasi-evenly. \notaL{Sigo sin
  entender. ¿La absorción del silicio poroso depende de la muestra?
  ¿Qué significa quasi-evenly? Quité el 'due', pues era mala redacción}
...
- \lambda_{j}=2+j$ (with its suitable units)\notaL{This is still
  ...
  700, $\lambda_2=700+2+2=704$, $\lambda_3=704+2+3=709\ldots$
...
has the largest previously reported OD width.

Finally, Table \ref{tab:table3} shows some porous silicon based OD
mirrors designed to operate in the NIRy
