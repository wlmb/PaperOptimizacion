...
silicon based ODM \hl{and quasi-ODM designed to operate in the NIR
...
nm. In other words, $S_3$ has \hl{a quasi-ODW 3.55 times larger}. Moreover, the
ODW of the structure reported by Xifre-Perez, et al. \cite{Xifre2005} represents only 17.6
\% of the \hl{quasi-ODW of our $S_2$ and $S_3$ structures}. Aditionally, the table
