...
\end{equation}%
\notaL{Quité el -1 en el numerador pues antes pusimos que j empezaba
  en 0}
...
\begin{figure}
  ...
  \end{center}
  \caption{Profiles of the functions $f_n(\xi_j)$ \notaL{¿No sería
      mejor rotular el eje horizontal de (a) y (c) como $\xi$ y que
      vaya de 0 a 1? Si no, recuerda que tomamos $j$ va de 0 a $N_p-1$} optimized for
...
Thus, our techniques allowed us to obtain very
good relatively thin quasi omnidirectional mirrors with wide bands
over different wavelength ranges.
\notaL{Me sospecho que lo que sigue era un poco improvisada esta respuesta, pues el
  resultado depende de la región espectral, contrastes, etc. Entiendo
  que estás contestando literalmente mi pregunta previa, pero desmerece las
  conclusiones. El lector sin experiencia se quedará en las mismas,
  además de ofendido de que te refieras en el texto a ellos
  directamente. Mejor quitémoslo:
...
\notaL{Quizás Vivechna quiera mencionar al ICF. Quizás Victor también,
  dado que puso este artículo en su reporte sobre su estancia en el icf.}
