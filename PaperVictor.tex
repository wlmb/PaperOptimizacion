...
silicon based ODM and quasi-ODM designed to operate in the NIR
...
the quasi-ODB of the structure $S_3$ begins at 950 nm like the one
...
\% of the quasi-ODW of our $S_2$ and $S_3$ structures. Aditionally, the table
...
structures with large quasi-omnidirectional bands with pairs of
materials that have a relatively low refractive index contrast. To be
fair, we have to point out that the (quasi-) omnidirectional band widths of the
structures compared above correspond to different angular ranges,
which are defined by instrumental constrictions.

\begin{table}
        \centering
        \begin{tabular}{rrrrrr}
                Reference&Year&Sample&\emph{q}-ODB (nm)&AR (degrees)&\emph{q}-ODW (nm)\\
                \hline
                \hline
...
We have designed, optimized, fabricated and characterized highly reflective quasi-omnidirectional (angular range of $0-60^\circ$) multilayered structures with a wide
...
we fabricated a stacked sub-Bragg mirror structure  with a quasi-omnidirectional bandwidth of 1800 nm (centered at 1850 nm) and a
