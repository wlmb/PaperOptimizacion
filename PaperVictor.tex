...
$\lambda_{\min}=850$ nm and $\lambda_{\min}=3000$ nm. \notaL{Any reason
  ...
  elegir la primer regi\'{o} era comparar la estructura optimizada con
  el espejo blanco obtenido por Ariza \cite{Ariza2012}. La segunda
  regi\'{o}n la eleg\'{i} porque es uno de los rangos m\'{a}ximos que
  puedo medir (200-3300) nm. En principio puedo optimizar en una
  regi\'{o}n m\'{a}s amplia, pero solo quedar\'{i}a en el c\'{a}lculo
  sin su complemento experimental.} \notaL{Creo que alguna explicación
  sencilla merece el lector.}
...
of width (ODW) 250 nm centered at (ODC) 1125 nm, as shown in Fig. \ref{Fig1}(b). \notaL{¿Por
  ...
  referencia que defina dicho criterio?}
\notaV{Alguna referencia que defina como tal este criterio, NO.
	...
	que hayamos obtenido y qu\'{e} queramos vender} \notaL{¿Sería
        correcto citar a Xu, Ahmed y Reiner entonces, para apuntalar
        nuestra definición?}
...
\notaL{En el texto no se aclara como defines el porcentaje de traslape
  de dos bandas. Valdría la pena definirlo para que el lector entiende
  qué significan los números en la tabla. Para mí no es obvio. Tienes
  el ancho de una banda, el ancho de la otra y el ancho de la región
  en que se traslapan. ¿Cómo combinas dichos números para producir un
  porcentaje de overlap?}
...
at 1160nm and 1925nm, respectively. We fabricated a
...
\notaV{Si el lector no tiene experiencia acerca de los materiales,
	...
	necesidades.} \notaL{Falta meterlo entonces a las conclusiones.}
