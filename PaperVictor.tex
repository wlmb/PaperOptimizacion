...
+ \lambda_{j}=2+j$ with 4 periods for each of the following 
periods.
...
In both designs, the optimal overlap of two consecutive PBGs was obtained that maximized reflectance.
...
the total number of stacked sub mirrors ($N_{se}$)
