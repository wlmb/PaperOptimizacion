...
reported.
\end{abstract}
\notaL{No sé si Vivechna quiera añadir al ICF y mencionar su estancia
  en los agrads.}
...
$\mathcal R_1$, and $98\%$ in $\mathcal R_2$ \notaL{¿qué es
  terrestrial solar? terrestrial solar radiation} \cite{Bird1983}. A direct
application of the optimized structures in these regions is solar
reflectors. \notaL{¿Pero por qué en un caso dejasta $\lambda_{\min}$
  fijo y en el otro caso no? Sería bueno que el lector entienda todas
  las decisiones que sean fáciles de explicar}
The
...
\notaL{¿Sería
	...
	nuestra definición?}
\notaV{Agregue:   }
Various works use $R>90\%$ as a criterium for defining
omnidirectional band, and
...
structure has an omnidirectional band (ODB) of width (ODW) 250 nm
centered at (ODC) 1125 nm, as shown in Fig. \ref{Fig1}(b).  Various
photonic structures have been reported with
omnidirectional bands (ODB's) \cite{Xu2018,Ahmed2014,Reiner2000} defined
through the criterium $R>90\%$ which we adopt here.
...
\notaV{Agregue:    } Thus, our techniques allowed us to obtain very
good relatively thin quasi omnidirectional mirrors with wide bands
over different wavelength ranges.
\notaL{Me sospecho que es un poco improvisada esta respuesta, pues el
  resultado depende de la región espectral, contrastes, etc. Entiendo
  que estás contestando mi pregunta previa, pero desmerece las
  conclusiones. El lector sin experiencia se quedará en las mismas,
  además de ofendido de que te refieras en el texto a ellos directamente:
